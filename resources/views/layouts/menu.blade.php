          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ url('book') }}">All Books</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('book/create') }}">Add Book</a></li>

                <li class="nav-item"> <a class="nav-link" href="{{ route('rant') }}">Rent Book</a></li>

                <li class="nav-item"> <a class="nav-link" href="{{ route('return') }}">Return Book</a></li>
